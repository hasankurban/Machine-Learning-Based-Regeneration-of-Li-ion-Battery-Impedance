...
ensemble1.RMSE <- caretEnsemble(models[-c(1,7,6,11,14)], 
                           metric = "RMSE", 
                           trControl = my_control)

ensemble1.MAE <- caretEnsemble(models[-c(1,7,6,11,14)], 
                                metric = "MAE", 
                                trControl = my_control)


ensemble1.Rsquared <- caretEnsemble(models[-c(1,7,6,11,14)], 
                               metric = "Rsquared", 
                               trControl = my_control)
